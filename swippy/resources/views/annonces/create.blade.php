        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('annonces.store') }}" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="file" id="photo" name="photo" class="mt-1 block w-full text-sm text-gray-500 dark:text-gray-400
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button>{{ __('Créer l\'annonce') }}</x-primary-button>
